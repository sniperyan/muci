...
const InlineChunkHtmlPlugin = require('../dev-utils/InlineChunkHtmlPlugin');
...
const publicUrl = config.build.publicUrl;
...
module.exports = {
    ...
    output: {
        ...
        devtoolModuleFilenameTemplate: info =>
            path
                .relative(resolve('src'), info.absoluteResourcePath)
                .replace(/\\/g, '/'),
    },
    // optimization: {
    //     minimizer: [
